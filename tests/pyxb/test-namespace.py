...
class TestExpandedName(unittest.TestCase):
    ...
    def testConstructor(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(
            '<ns1:%s xmlns:ns1="%s" attr="52">content</ns1:%s>' % (ln, ns_uri, ln)
        )
...
class TestCategories(unittest.TestCase):
    ...
    def testNoCategory(self):
        self.assertRaises(
            pyxb.NamespaceError, pyxb.namespace.XMLSchema.categoryMap, "not a category"
        )
