...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/test-mg-choice.xsd")
)
...
class TestMGChoice(unittest.TestCase):
    ...
    def testMissingSingle(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, choice.createFromDOM, dom.documentElement
        )
    ...
    def testTooManySingle(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, choice.createFromDOM, dom.documentElement
        )
    ...
    def testMultichoice(self):
        ...
        xmlt = six.u(
            '<ns1:multiplechoice xmlns:ns1="URN:test-mg-choice"><first/></ns1:multiplechoice>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = multiplechoice.createFromDOM(dom.documentElement)
        ...
        xmlt = six.u(
            '<ns1:multiplechoice xmlns:ns1="URN:test-mg-choice"><first/><first/><first/><third/></ns1:multiplechoice>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = multiplechoice.createFromDOM(dom.documentElement)
    ...
    def testMultichoiceOrderImportant(self):
        xmlt = six.u(
            '<ns1:multiplechoice xmlns:ns1="URN:test-mg-choice"><first/><third/><first/></ns1:multiplechoice>'
        )
        xmld = xmlt.encode("utf-8")
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = multiplechoice.createFromDOM(dom.documentElement)
    ...
    def testTooManyChoices(self):
        xmlt = six.u(
            '<ns1:altmultiplechoice xmlns:ns1="URN:test-mg-choice"><first/><first/><first/><third/></ns1:altmultiplechoice>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError,
            altmultiplechoice.createFromDOM,
            dom.documentElement,
        )
    ...
    def testFixedMultichoice(self):
        ...
        xmlt = six.u(
            '<ns1:fixedMultichoice xmlns:ns1="URN:test-mg-choice"><A/><A/></ns1:fixedMultichoice>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        instance = fixedMultichoice.createFromDOM(dom.documentElement)
        xmlt = six.u(
            '<ns1:fixedMultichoice xmlns:ns1="URN:test-mg-choice"><A/><B/></ns1:fixedMultichoice>'
        )
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError,
            fixedMultichoice.createFromDOM,
            dom.documentElement,
        )
