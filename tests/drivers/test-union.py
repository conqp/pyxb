...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/test-union.xsd")
)
...
class TestUnion(unittest.TestCase):
    ...
    def testXMLErrors(self):
        self.assertEqual(
            welsh.un,
            CreateFromDocument('<myElement xmlns="URN:unionTest">un</myElement>'),
        )
        self.assertRaises(
            UnrecognizedDOMRootNodeError, CreateFromDocument, "<welsh>un</welsh>"
        )
        self.assertRaises(
            UnrecognizedDOMRootNodeError,
            CreateFromDocument,
            "<myelement>un</myelement>",
        )

    def testMyElementDOM(self):
        self.assertEqual(
            0,
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest">0</myElement>'
                ).documentElement
            ),
        )
        self.assertEqual(
            0, CreateFromDocument('<myElement xmlns="URN:unionTest">0</myElement>')
        )
        ...
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest">one</myElement>'
                ).documentElement
            ),
        )
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest">un</myElement>'
                ).documentElement
            ),
        )
        ...
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest">one<!-- with comment --></myElement>'
                ).documentElement
            ),
        )
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest"><!-- with comment -->un</myElement>'
                ).documentElement
            ),
        )
        ...
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    '<myElement xmlns="URN:unionTest"> one <!-- with comment and whitespace --></myElement>'
                ).documentElement
            ),
        )
        self.assertRaises(
            ...
            myElement.createFromDOM,
            pyxb.utils.domutils.StringToDOM(
                '<myElement xmlns="URN:unionTest"><!-- whitespace is error for welsh --> un</myElement>'
            ).documentElement,
        )
        ...
        self.assertEqual(
            ...
            myElement.createFromDOM(
                pyxb.utils.domutils.StringToDOM(
                    """<myElement xmlns="URN:unionTest"><!-- whitespace is collapsed for english -->
one
</myElement>"""
                ).documentElement
            ),
        ...
        self.assertRaises(
            ...
            myElement.createFromDOM,
            pyxb.utils.domutils.StringToDOM(
                """<myElement xmlns="URN:unionTest"><!--whitespace is only reduced for welsh -->
un
</myElement>"""
            ).documentElement,
        )
