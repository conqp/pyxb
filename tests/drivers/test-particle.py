...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/particle.xsd")
)
...
class TestParticle(unittest.TestCase):
    def test_bad_creation(self):
        ...
        self.assertRaises(
            pyxb.StructuralBadDocumentError, h01b.createFromDOM, dom.documentElement
        )
    ...
    def test_h01_elt2(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, h01.createFromDOM, dom.documentElement
        )
    ...
    def test_h01b_elt2(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            UnrecognizedContentError, h01b.createFromDOM, dom.documentElement
        )
    ...
    def test_h11_empty(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, h11.createFromDOM, dom.documentElement
        )
    ...
    def test_h24(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, h24.createFromDOM, dom.documentElement
        )

        for num_elt in range(0, 5):
            xmlt = six.u('<ns1:h24 xmlns:ns1="URN:test">%s</ns1:h24>') % (
                "".join(num_elt * ["<elt/>"]),
            )
            dom = pyxb.utils.domutils.StringToDOM(xmlt)
            if 2 > num_elt:
                ...
                self.assertRaises(
                    UnrecognizedContentError, h24.createFromDOM, dom.documentElement
                )
    ...
    def test_h24b(self):
        ...
        dom = pyxb.utils.domutils.StringToDOM(xmlt)
        self.assertRaises(
            IncompleteElementContentError, h24b.createFromDOM, dom.documentElement
        )

        for num_elt in range(0, 5):
            xmlt = six.u('<ns1:h24b xmlns:ns1="URN:test">%s</ns1:h24b>') % (
                "".join(num_elt * ["<elt/>"]),
            )
            dom = pyxb.utils.domutils.StringToDOM(xmlt)
            if 2 > num_elt:
                ...
                self.assertRaises(
                    UnrecognizedContentError, h24b.createFromDOM, dom.documentElement
                )
