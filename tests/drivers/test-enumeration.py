...
schema_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../schemas/enumerations.xsd")
)
...
class TestEnumerations(unittest.TestCase):
    def testString(self):
        ...
        self.assertRaises(
            pyxb.SimpleTypeValueError, CreateFromDocument, "<eString>fourteen</eString>"
        )
    ...
    def testInteger(self):
        ...
        self.assertRaises(pyxb.SimpleTypeValueError, eInteger, "4")
        self.assertRaises(
            pyxb.SimpleTypeValueError, CreateFromDocument, "<eInteger>4</eInteger>"
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, eInteger
        )  # Value defaults to zero, not in enumeration
    ...
    def testDouble(self):
        ...
        self.assertRaises(pyxb.SimpleTypeValueError, eDouble, "2.0")
        self.assertRaises(
            pyxb.SimpleTypeValueError, CreateFromDocument, "<eDouble>2</eDouble>"
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, CreateFromDocument, "<eDouble>2.0</eDouble>"
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, eDouble
        )  # Value defaults to zero, not in enumeration
    ...
    def testAny(self):
        ...
        self.assertRaises(pyxb.SimpleTypeValueError, eAny, "2")
        self.assertRaises(
            pyxb.SimpleTypeValueError, CreateFromDocument, "<eAny>2</eAny>"
        )
    ...
    def testList(self):
        ...
        self.assertEqual([1, 1, 2, 3], eListInt((1, 1, 2, 3)))
        self.assertEqual(
            [1, 1, 2, 3], CreateFromDocument("<eListInt>1 1 2 3</eListInt>")
        )
    ...
    def testJustUnion(self):
        ...
        self.assertEqual(
            [1, 1, 2, 3, 5, 8],
            CreateFromDocument("<eJustVarious>1 1 2 3 5 8</eJustVarious>"),
        )
