...
class Test_hexBinary(unittest.TestCase):
    ...
    def testBadStrings(self):
        self.assertRaises(
            SimpleTypeValueError, xsd.hexBinary.Factory, six.u("0"), _from_xml=True
        )
        self.assertRaises(
            SimpleTypeValueError, xsd.hexBinary.Factory, six.u("012"), _from_xml=True
        )
        self.assertRaises(
            SimpleTypeValueError, xsd.hexBinary.Factory, six.u("01s"), _from_xml=True
        )
        self.assertRaises(
            SimpleTypeValueError, xsd.hexBinary.Factory, six.u("sb"), _from_xml=True
        )
