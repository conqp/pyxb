...
class Test_base64Binary(unittest.TestCase):
    RFC4648_S9 = (
        (six.u("14fb9c03d97e"), six.u("FPucA9l+")),
    ...
    def testLimitOverride(self):
        ...
        self.assertEqual(
            six.b("e\x96"), xsd.base64Binary(six.u("ZZY="), _from_xml=True)
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("ZZZ="), _from_xml=True
        )
        xsd.base64Binary.XsdValidateLength(-1)
        self.assertEqual(
            six.b("e\x96"), xsd.base64Binary(six.u("ZZZ="), _from_xml=True)
        )
    ...
    def testInvalid(self):
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("Z"), _from_xml=True
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("Zg"), _from_xml=True
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("Zg="), _from_xml=True
        )
        self.assertEqual(
            six.u("f").encode("utf-8"), xsd.base64Binary(six.u("Zg=="), _from_xml=True)
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("ZZZ="), _from_xml=True
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("ZZ=="), _from_xml=True
        )
        self.assertRaises(
            pyxb.SimpleTypeValueError, xsd.base64Binary, six.u("ZE=="), _from_xml=True
        )
