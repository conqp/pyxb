...
class TestIssue0071(unittest.TestCase):
    ...
    def testTime(self):
        ...
        self.assertEqual(
            datetime.time(), CreateFromDocument(six.u("<time>00:00:00</time>"))
        )
    ...
    def testDuration(self):
        ...
        self.assertEqual(
            datetime.timedelta(), CreateFromDocument(six.u("<duration>P0D</duration>"))
        )
        self.assertRaises(
            SimpleTypeValueError, CreateFromDocument, six.u("<duration/>")
        )
