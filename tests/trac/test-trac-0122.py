...
class TestTrac0122(unittest.TestCase):
    ...
    def testBasic(self):
        ...
        self.assertRaises(
            pyxb.ProhibitedAttributeError, self.setProhibitedNaive, instance, "three"
        )
        self.assertRaises(
            pyxb.ProhibitedAttributeError, self.setProhibited, instance, "three"
        )
        ...
        self.assertRaises(
            pyxb.ProhibitedAttributeError, self.setProhibited, instance, None
        )
        self.assertEqual("one", instance.Required)
        self.assertEqual(None, instance.Optional)
        self.assertRaises(pyxb.ProhibitedAttributeError, self.getProhibited, instance)
