...
class TestTrac0023(unittest.TestCase):
    def testBasic(self):
        ...
        self.assertEqual(
            ...
            structure._AttributeMap[
                pyxb.namespace.XML.createExpandedName("lang")
            ].dataType(),
        )
        self.assertEqual(
            pyxb.binding.xml_.STD_ANON_space,
            structure._AttributeMap[
                pyxb.namespace.XML.createExpandedName("space")
            ].dataType(),
        )
        self.assertEqual(
            pyxb.binding.datatypes.anyURI,
            structure._AttributeMap[
                pyxb.namespace.XML.createExpandedName("base")
            ].dataType(),
        )
        self.assertEqual(
            pyxb.binding.datatypes.ID,
            structure._AttributeMap[
                pyxb.namespace.XML.createExpandedName("id")
            ].dataType(),
        )
