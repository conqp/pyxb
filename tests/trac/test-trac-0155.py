...
<OpaqueData xmlns="http://schema.omg.org/spec/CTS2/1.0/Core"
    ...
    Expectedd = """<?xml version="1.0" encoding="utf-8"?><OpaqueData xmlns="http://schema.omg.org/spec/CTS2/1.0/Core" xmlns:ns1="http://www.w3.org/1999/xhtml"><v><ns1:ul><ns1:li>entry1</ns1:li><ns1:li>entry2</ns1:li></ns1:ul></v></OpaqueData>""".encode(
        "utf-8"
    )
